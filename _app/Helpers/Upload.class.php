...
class Upload {
    ...
    function __construct($BaseDir = null) {
        ...
        if (!file_exists(self::$BaseDir) && !is_dir(self::$BaseDir)):
            Diretorio::criaDir(self::$BaseDir);
        endif;
    }
    ...
    private function CreateFolder($Folder) {
        if (!file_exists(self::$BaseDir . $Folder) && !is_dir(self::$BaseDir . $Folder)):
            Diretorio::criaDir(self::$BaseDir . $Folder);
        endif;
    }
    ...
    private function UploadImage() {
        ...
        switch ($this->File['type']):
            ...
            case 'image/x-xbm':
            case 'image/xbm':
                $this->Image = imagecreatefromxbm($this->File['tmp_name']);
                break;
        endswitch;
        ...
        if (!$this->Image):
            ...
            switch ($this->File['type']):
                ...
                case 'image/x-xbm':
                case 'image/xbm':
                    imagexbm($NewImage, self::$BaseDir . $this->Send . $this->Name);
                    break;
            endswitch;
