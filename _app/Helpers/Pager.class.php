...
class Pager {
    ...
    function __construct($Link, $First = null, $Last = null, $MaxLinks = null) {
        ...
        $this->First = ( (string) $First ? $First : "<i class='entypo-left-open-mini'></i>" );
        $this->Last = ( (string) $Last ? $Last : "<i class='entypo-right-open-mini'></i>" );
    ...
    public function ReturnPage() {
        if ($this->Page > 1):
            $nPage = $this->Page - 1;
            ?><script>$(location).attr('href','<?="{$this->Link}{$nPage}";?>');</script><?php
        endif;
    }
    ...
    private function getSyntax() {
        ...
        if ($this->Rows > $this->Limit):
            ...
            $this->Paginator = "<ul class=\"pagination pagination-lg\">";
